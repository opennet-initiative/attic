...
class KMLFileWriter(LQColorMap):
   ...
   def markup_generate(self):
      ...
      color_style_tags = ['<Style id="col%s"><IconStyle><color>%s</color></IconStyle><LineStyle><color>%s</color><width>0.25</width></LineStyle></Style>\n' % (cs, cs, cs) for cs in color_set]
